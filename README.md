...
- 毎日: `[1日1回]` と表示される毎日の魔法石報酬
- 毎週: `[週1回]` と表示される週次の魔法石報酬、または旧名称のラグジュアリー報酬

## 仕組み

- Playwright で `https://slvshop.netmarble.com/ja/item` を開きます。
- `[1日1回]` / `[週1回]` の獲得ボタンのうち、魔法石系またはラグジュアリー報酬だけを受け取ります。
- マイレージ報酬は受け取り対象から除外します。
...
- 毎日 09:37 JST: `[1日1回]` の毎日の魔法石報酬
- 毎週 木曜 09:42 JST: `[週1回]` の週次の魔法石報酬
